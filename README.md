...
- 메인 메뉴에서 2번을 선택하면, 랜덤 뽑기 메뉴로 진입하며 금액 투입 시스템이 작동합니다.
...
- 종류별 지폐를 원하는 만큼 투입 한 후 다음 단계 메뉴를 누르면 랜덤 뽑기 단계로 진입합니다.
...
- 랜덤 게임 진행 버튼을 누르면 금액이 차감되며 확률에 따라 다른 인형이 특정 위치에 출력되며 뽑힙니다.
...
- 메인 메뉴에서 3번인 종료를 선택할 경우, 모든 인형 이미지를 각각의 특정 위치에 출력하며 프로그램이 정상 종료됩니다.
